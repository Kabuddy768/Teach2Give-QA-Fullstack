...
const {
  ...
  payment: {
    ...
    transactions,
    //   { id: idTransaction, amount: amount, description: description },
...
// personalInfo.innerHTML=`${id} ${first} ${last} ${email}`
...
transaction.innerHTML = `<h2>Transactions<h2><ul>${transactions
  .map(
    (transaction) =>
